...
//	if(temprature>=40)
//	{
//   	cout<<"\nStay indoors because it is extremely hot and could be dangerous to health.";
//    }
//	else if(temprature>=30 && temprature<=39)
//	{
//   	cout<<"\nDrinking plenty of water to stay hydrated in the hot weather.";
//    }
//	else if(temprature>=20 && temprature<=29)
//	{
//   	cout<<"\nThe weather is pleasent and suitable for outdoor activities.";
//    }else
//	{
//   	cout<<"\nWearing warm clothes to stay comfortable in the cooler weather.";
//    }
